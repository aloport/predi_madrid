...
---
title: Tendencias respecto al día anterior
---
...
datatable(vote_table, rownames=FALSE, colnames = c('Partido', 'Voto', 'Variación desde ayer (voto)', 'Escaños', 'Variación desde ayer (escaños)'), extensions = 'FixedColumns',
  options = list(
    dom = 'r',
    scrollX = TRUE,
